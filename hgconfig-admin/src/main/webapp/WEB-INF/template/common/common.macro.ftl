...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>HG</b>Config</span>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#list roleResourceList as item>
					<#if item.methodMask == '1'>
                        <li class="nav-click" ><a href="${item.urlPattern}"><i class="fa fa-circle-o text-red"></i> <span>${item.urlDescription}</span></a></li>
					</#if>
				</#list>
			</ul>
		</section>
